...
import {ADD_CONSTRUCTOR_INGREDIENT, DEL_CONSTRUCTOR_INGREDIENT, MOVE_CONSTRUCTOR_ITEM,} from '../constants/constructor';
import {ADD_ORDER_SUCCESS} from './order';

export {
    MOVE_CONSTRUCTOR_ITEM, ADD_CONSTRUCTOR_INGREDIENT,
    DEL_CONSTRUCTOR_INGREDIENT, ADD_ORDER_SUCCESS
};

interface IMoveConstructorItemAction {
...
interface IDelConstructorIngredientAction {
    readonly type: typeof DEL_CONSTRUCTOR_INGREDIENT;
    readonly index: number;
}

interface IAddOrderSuccessAction {
...
export type TConstructorAction =
    ...
    | IDelConstructorIngredientAction
