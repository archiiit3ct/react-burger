...
interface IRegisterReqestAction {
...
interface IRefreshReqestAction {
    readonly type: typeof REFRESH_REQUEST;
}

interface IRefreshSuccessAction {
    readonly type: typeof REFRESH_SUCCESS;
}

interface IRefreshErrorAction {
    readonly type: typeof REFRESH_ERROR;
}

interface IForgotReqestAction {
...
interface IForgotErrorAction {
    readonly type: typeof FORGOT_ERROR;
}

interface IResetReqestAction {
...
interface IEditErrorAction {
    readonly type: typeof EDIT_ERROR;
}

export type TAuthAction =
    IRegisterReqestAction
...
export const forgot: AppThunk = (email: string, history: RouteComponentProps["history"]) => (dispatch) => {
    ...
    fetch(`${url}password-reset`, {
        ...
        .then(() => {
            ...
            history.replace('/reset-page-password');
        })
        .catch(() => {
            dispatch({
                type: FORGOT_ERROR,
